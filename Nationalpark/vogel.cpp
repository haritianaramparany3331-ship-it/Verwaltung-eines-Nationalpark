...
Spezies* Vogel::deserialize(std::ifstream &in, std::string &bezeichnung, bool &gefaehrdet, bool &raubtier){
    bool zugvogel;
    ...
    return new Vogel(bezeichnung, gefaehrdet, raubtier, zugvogel, flugreichweite, fluegelspannweite);
}
